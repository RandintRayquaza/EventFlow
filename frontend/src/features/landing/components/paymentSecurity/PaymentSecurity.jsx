...
const PaymentSecurity = () => {
  return (
    <Section id="payment-security" className="bg-[#000000] relative border-t border-[var(--color-border)] py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          {/* Payment Section */}
          <div className="flex flex-col justify-center rounded-3xl border border-[var(--color-border)] bg-[#0a0a0a] p-8 md:p-12 relative overflow-hidden" data-scroll-reveal>
            ...
            <div className="space-y-4 max-w-sm">
               <div className="flex justify-between items-center pb-4 border-b border-[#262626]">
                 ...
                 <span className="font-mono text-white text-sm font-bold opacity-80 border border-white/20 px-2 py-1 rounded bg-white/10">Small fee</span>
               </div>
               <div className="flex justify-between items-center pb-4 border-b border-[#262626]">
                 <span className="text-gray-300">Host revenue</span>
                 <span className="font-mono text-white text-sm font-bold opacity-80 border border-[#262626] px-2 py-1 rounded bg-[#171717]">Keep the most</span>
               </div>
            </div>
          </div>
