...
import { Mail, Lock, Calendar, Zap, User } from "lucide-react";
import { useAuthActions, useAuthState } from "../../Hooks/auth.hook";
...
const SignUp = () => {
  ...
  const { register, loginWithGoogle, dismissError } = useAuthActions();
        ...
        <div className="flex flex-col gap-8 max-w-xs text-center lg:text-left">
          ...
          <div>
            <h1 className="text-5xl font-extrabold leading-none mb-4"
              ...
              Create.<br />
              <span style={{ color: "var(--color-primary)" }}>Connect.</span><br />
              Celebrate.
            </h1>
            <p className="text-sm leading-relaxed" style={{ color: "var(--color-text-muted)" }}>
              Join thousands of event organizers who trust EventFlow to make every event unforgettable.
            </p>
          </div>
        ...
        >
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="text-sm" style={{ color: "var(--color-text-muted)" }}>
              Start managing events for free today
            </p>
          </div>
